...
+ [[https://github.com/shahinism/python-negar][python-negar]]: an editor (=virastar in Persian) for Persian text. It
  was initially inspired by a [[https://github.com/aziz/virastar][Virastar]], a Ruby based project.
